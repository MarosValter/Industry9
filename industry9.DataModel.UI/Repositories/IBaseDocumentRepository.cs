...
namespace industry9.DataModel.UI.Repositories
{
    public interface IBaseDocumentRepository<TDocument> where TDocument : IDocument
    {
        ...
        Task UpsertDocumentAsync(TDocument document, CancellationToken cancellationToken = default);
        ...
        Task<DeleteResult> DeleteDocumentAsync(string id, CancellationToken cancellationToken = default);
    }
}